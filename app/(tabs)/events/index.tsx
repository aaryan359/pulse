...
import { Event, formatTimeAgo, mockEvents } from "@/utils/mock-data"
...
export default function EventsScreen() {
  ...
  const events = useMemo(() => {
    return severity
      ? mockEvents.filter((e) => e.severity === severity)
      : mockEvents
  }, [severity])
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {events.length === 0 && (
          <View style={styles.empty}>
            <CheckCircle size={40} color={colors.statusOnline} />
