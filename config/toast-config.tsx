...
import { swipeDismiss } from "./toast-swipeDismiss";

export const toastConfig = {
	success: ({ text1, text2, hide }: any) => {
		const pan = swipeDismiss(hide);
		...
		return (
			<View
				...
				<View style={{ flex: 1 }}>
					...
					{text2 && (
						<Text style={{ color: "#D92D20", fontSize: 13, fontFamily: "Inter-Regular", marginTop: 4 }}>
							{text2}
						</Text>
					)}
				</View>
		...
		return (
			<View
				...
				<View style={{ flex: 1 }}>
					...
					{text2 && (
						<Text style={{ color: "#3E7BFA", fontSize: 13, fontFamily: "Inter-Regular", marginTop: 4 }}>
							{text2}
						</Text>
					)}
				</View>
